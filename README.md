...
| Груздев Владислав Евгеньевич | Backend Dev #1 | VG676 | Модели БД, CRUD заявок/абитуриентов/программ |
| Коба Тимофей Сергеевич | Backend Dev #2 | Eriz | Pydantic-валидации, дашборд-метрики, экспорт xlsx, дашборд |
